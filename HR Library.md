# HR Library
This documentation is for the stable release of HR Library.

## Booting the Library
```lua
local HRLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/HR/main/source')))()
```
...
## Creating a Window
```lua
local Window = HRLib:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
print(HRLib.Flags["toggle"].Value) -- prints the value of the toggle.
```
